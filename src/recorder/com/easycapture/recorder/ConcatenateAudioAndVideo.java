...
//    }
    ...
    File source1 = new File("output2.mp4");
    File source2 = new File("output3.mp4");
    ...
    //concatenate("output2.mp4", "deneme.wav", "output59.mp4");
  }
  ...
  public static void concatenate(String sourceUrl1, String sourceUrl2,
    String destinationUrl, Rectangle bounds)
  {
